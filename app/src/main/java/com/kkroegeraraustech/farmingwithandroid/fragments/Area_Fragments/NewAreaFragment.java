package com.kkroegeraraustech.farmingwithandroid.fragments.Area_Fragments;
 ...
 */
public class NewAreaFragment extends Fragment implements View.OnClickListener{

    private static String TAB_NAME = "AREA DESCRIPTION";
    ...
    public static NewAreaFragment newInstance(String param1, String param2) {
        NewAreaFragment fragment = new NewAreaFragment();
    ...
    public static NewAreaFragment getInstance(int position) {
        NewAreaFragment fragmentDummy = new NewAreaFragment();
        Bundle args = new Bundle();
