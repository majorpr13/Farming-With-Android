 ...
 */
public class ReviewFieldFragment extends Fragment implements View.OnClickListener{
    ...
    public static ReviewFieldFragment newInstance(String param1, String param2) {
        ReviewFieldFragment fragment = new ReviewFieldFragment();
    ...
    public static ReviewFieldFragment getInstance(int position) {
        ReviewFieldFragment fragmentDummy = new ReviewFieldFragment();
        Bundle args = new Bundle();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Adapter_FieldExpandableList adapterUserItems = new Adapter_FieldExpandableList(getActivity(), groups);
