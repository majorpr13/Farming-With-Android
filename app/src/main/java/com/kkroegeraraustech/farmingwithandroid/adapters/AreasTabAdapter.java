 ...
 */
public class AreasTabAdapter extends FragmentStatePagerAdapter implements Constants {

    private CharSequence[] Titles;// This will Store the Titles of the Tabs which are Going to be passed when ViewPagerAdapter is created
    int NumbOfTabs; // Store the number of tabs, this will also be passed when the ViewPagerAdapter is created


    public AreasTabAdapter(FragmentManager fm){
        super(fm);
    ...
    public AreasTabAdapter(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
        this.Titles = mTitles;
