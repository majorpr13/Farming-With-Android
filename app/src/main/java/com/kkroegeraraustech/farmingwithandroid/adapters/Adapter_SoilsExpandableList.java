 ...
 */
public class Adapter_SoilsExpandableList extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<ExpandableListItems_Parent_Fields> groups;

    public Adapter_SoilsExpandableList(Context context, ArrayList<ExpandableListItems_Parent_Fields> groups) {
