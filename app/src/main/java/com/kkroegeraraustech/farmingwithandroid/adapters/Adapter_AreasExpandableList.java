 ...
 */
public class Adapter_AreasExpandableList extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<ExpandableListItems_Parent_Fields> groups;

    public Adapter_AreasExpandableList(Context context, ArrayList<ExpandableListItems_Parent_Fields> groups) {
